...
const BASE_URL = 'https://anil-itagi.github.io/Quiz_API/worldwise.json'
    ...
    async function fetchCities() {
      ...
      try {
        ...
        dispatch({ type: 'cities/loaded', payload: data });
          ...
          dispatch({type:'rejected',payload:"There is a error in fetching the data"})
      }
    }
    fetchCities();
  }, [])
  ...
  async function getCity(id) {
    ...
    if (Number(id) === currentCity.id) return;
      ...
      try {
        ...
        dispatch({type:'rejected',payload:"There is a error in geting a current city from API"})
      }
  ...
  async function createCity(newCity) {
     dispatch({ type: 'loading' });
      try {  
       ...
       dispatch({type:'rejected',payload:"there was an error in creating city"})
      }
